...
Análises de desempenho são definidas como investiga\c c\~{o}es técnicas realizadas para determinar a capacidade de resposta, a confiabilidade ou escalabilidade de um sistema, sob uma determinada carga de trabalho~\cite{Meier2007}.
...
Foram realizados 10 testes, conforme cenários apresentados na Tabela~\ref{tb:tb_testes}.
